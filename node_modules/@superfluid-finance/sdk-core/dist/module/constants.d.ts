...
export declare const AUTHORIZE_FLOW_OPERATOR_UPDATE: number;
export declare const AUTHORIZE_FLOW_OPERATOR_DELETE: number;
export declare const AUTHORIZE_FULL_CONTROL: number;
export declare const chainIdToResolverDataMap: Map<number, IResolverData>;
